...
def send_remediation_alert(
    ...
    Args:
        fixed_count: Number of records fixed
        failed_count: Number of records failed to fix
        total_valid: Total valid records
        total_invalid: Total invalid records
    ...
    subject_prefix = "🔴 REMEDIATION FAILED" if has_failures else "✅ REMEDIATION COMPLETE"
